...
void	add_t_node_empty_list(t_list *list, t_node *new_t_node)
{
...
void	add_t_node_non_empty_list(t_list *list, t_node *new_t_node)
{
...
int	add_t_node(t_list *list, int value)
{
	...
	new_t_node->cost = 0;
	if (list->size == 0)
		add_t_node_empty_list(list, new_t_node);
	else
		add_t_node_non_empty_list(list, new_t_node);
	list->size++;
	return (1);
}
